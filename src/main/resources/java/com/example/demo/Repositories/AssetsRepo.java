...
public interface AssetsRepo extends CrudRepository<AssetsEntity, Integer> {
    ...
    @Query(value = "select * from  assets_entity where user_foreign_key = ?1 and inp_date like ?2", nativeQuery = true)
    List<AssetsEntity> getAssetsForMonth(int id, String month);
