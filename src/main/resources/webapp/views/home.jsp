    ...
    <div class="row ">
        ...
        <div class="col-md-8 mt-sm-12 mt-md-0 bg-light">
            ...
            <div class="mt-sm-4 mt-md-4 mt-lg-0 text-center">
                <form action="/user/home">
                    <input hidden type="month" name="month">
                ...
                <form action="/user/home">
                    <input hidden type="date" name="date">
                    <label for="inputDate" class="form-label">Filter By Month  </label>
                    <input id="" type="month" name="month">
                    <input type="submit">
                </form>
