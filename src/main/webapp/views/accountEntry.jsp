...
<div class="container-fluid mt-5  ">
    ...
    <div class="row ">
        ...
        <div class="offset-md-1 col-md-4 bg-light  shadow-lg ml-5">
                <div>
                    <h1 style="color: tomato;" class="text-center ">Ammounts Entry </h1>
                    <hr>
                </div>
            <div class="row ">
        ...
        <div class=" offset-md-1 col-md-5   ">
            <div class="container bg-light shadow-lg p-5">
                ...
                <div class="mt-5 p-4">
                    ...
                    <ol>
                        <li class="p-4">When you get your unpaid sale then you should subtract that ammount from unpaid option, and must sum up in sale and profit option.</li>
                        <li class="p-4"> Your Withdraw limitaton is profit range</li>
                        <li class="p-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe iure, ducimus beatae maxime id odio.</li>
